...
var options = function(type, height, numbers , color){
  ...
  if (analytics_1 != null && typeof(analytics_1) != 'undefined') {
      var chart = new ApexCharts(analytics_1[0], options("area" , '150px' , numArr(10,99) , '#F79429')); 
      var chart_1 = new ApexCharts(analytics_1[1], options("area" , '150px' , numArr(10,99) , '#F79429')); 
      chart.render();       
      chart_1.render();       
  }
